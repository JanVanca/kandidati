...
@Entity
@Table(name = "kandidati_starostovia_2018")
public class KandidatiStarostovia2018 {
    ...
    public boolean equals(Object o) {
        ...
        KandidatiStarostovia2018 that = (KandidatiStarostovia2018) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, kodKraja, nazovKraja, kodUzemnehoObvodu, nazovUzemnehoObvodu, kodOkresu, nazovOkresu, kodObce, nazovObce, meno, priezvisko, pohlavie, politickySubjekt);
    }

    @Override
    public String toString() {
        return "KandidatiStarostovia2018{" +
                "id=" + id +
                ", kodKraja=" + kodKraja +
