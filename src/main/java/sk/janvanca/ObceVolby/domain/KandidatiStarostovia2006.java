...
@Entity
@Table(name = "kandidati_starostovia_2006")
public class KandidatiStarostovia2006 {
    ...
    public KandidatiStarostovia2006() {
    }

    public KandidatiStarostovia2006(@Nullable Integer kodObvodu, @Nullable String nazovObvodu, @NonNull String nazovObce, @NonNull String meno, @NonNull String priezvisko, @Nullable Character pohlavie, @Nullable Integer pocetHlasov, @Nullable String politickySubjekt) {
    ...
    public boolean equals(Object o) {
        ...
        KandidatiStarostovia2006 that = (KandidatiStarostovia2006) o;
